                            ...
                            <form onSubmit={handlePay}>
                                ...
                                <div style={{ marginBottom: '1.25rem' }}>
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Write what you'd like the celebrity to say..."
                    ...
                    {step === 3 && (
                        <div style={{ textAlign: 'center', padding: '2rem 1rem' }}>
                            ...
                            <p style={{ color: '#666', fontSize: '0.9rem', marginBottom: '1.5rem' }}>
                                ...
                                You'll receive it within <strong>{product.delivery_days || 3} working days</strong>.
                            </p>
...
export default function Products({ products }) {
    ...
    const filtered = filter === 'all' ? products
        : filter === 'wish' ? products.filter(p => p.is_celebrity_wish)
                            ...
                            >
                                ...
                                <div style={{ padding: '1.25rem' }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.5rem' }}>
                                        ...
                                        >
                                            {isWish ? '🎬 Book Now' : p.type === 'digital' ? '⬇ Download' : '🛒 Buy Now'}
                                        </button>
                                    </div>
                                </div>
                            </div>
